...
BASE_DIR = os.environ.get("HABITAT_OUTPUT", os.path.expanduser("~/habitat_mapping/output/output_it3"))
...
TRAIN_MASK = os.path.join(DATA_BASE, "masks_it3/training")
VAL_IMG = os.path.join(DATA_BASE, "tiles/validation")
VAL_MASK = os.path.join(DATA_BASE, "masks_it3/validation")
TEST_IMG = os.path.join(DATA_BASE, "tiles/test")
TEST_MASK = os.path.join(DATA_BASE, "masks_it3/test")
